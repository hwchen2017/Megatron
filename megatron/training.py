...
def pretrain(train_valid_test_dataset_provider,
    ...
    def save_profile_trace(prof):
        ...
        # print(output)
        if torch.distributed.get_rank() == 0:
            prof.export_chrome_trace(f"/home/code/profile/4A100_GPT_2.7b_b4s1024_mcore_0.5_DP1_fp16_setup_model_and_optimizer.json")
...
def get_model(model_provider_func, model_type=ModelType.encoder_or_decoder, wrap_with_ddp=True):
    ...
    # print("all_reduce_grad_type", args.accumulate_allreduce_grads_in_fp32)
    # raise RuntimeError
...
def train(forward_step_func, model, optimizer, opt_param_scheduler,
    ...
    def trace_handler(prof):
        ...
        # print(output)
        if torch.distributed.get_rank() == 0:
            prof.export_chrome_trace(f"/home/code/profile/4A100_GPT_2.7b_b4s1024_mcore_0.5_DP1_fp16_overlap-grad-reduce.json")
